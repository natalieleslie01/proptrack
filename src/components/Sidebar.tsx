...
const navItems: NavItem[] = [
  { id: 'nav-dashboard', label: 'Dashboard', icon: 'LayoutDashboardIcon', href: '/dashboard', group: 'main' },
  { id: 'nav-alerts', label: 'Action Alerts', icon: 'BellRingIcon', href: '/dashboard', badge: 27, group: 'main' },
  { id: 'nav-properties', label: 'Properties', icon: 'BuildingIcon', href: '/property-management', badge: 3, group: 'main' },
  { id: 'nav-clients', label: 'Clients', icon: 'UsersIcon', href: '/clients', group: 'main' },
  { id: 'nav-matching', label: 'Property Matching', icon: 'GitMergeIcon', href: '/property-matching', group: 'main' },
  { id: 'nav-enquiries', label: 'Enquiries', icon: 'InboxIcon', href: '/enquiries', group: 'main' },
  { id: 'nav-tenants', label: 'Tenants', icon: 'UserCheckIcon', href: '/tenants', group: 'main' },
  { id: 'nav-tenancies', label: 'Tenancies', icon: 'KeyIcon', href: '/active-tenancies', badge: 7, group: 'main' },
  { id: 'nav-tenancy-records', label: 'Tenancy Records', icon: 'ClipboardListIcon', href: '/tenancy-records', group: 'main' },
  { id: 'nav-key-inventory', label: 'Key Inventory', icon: 'KeyRoundIcon', href: '/key-inventory', group: 'main' },
  { id: 'nav-renewals', label: 'Lease Renewals', icon: 'RefreshCwIcon', href: '/lease-renewals', badge: 6, group: 'main' },
  { id: 'nav-handover', label: 'Tenancy Handover', icon: 'ArchiveIcon', href: '/tenancy-handover', group: 'main' },
  { id: 'nav-archive', label: 'Archived Tenancies', icon: 'ArchiveRestoreIcon', href: '/archived-tenancies', group: 'main' },
  { id: 'nav-sales-workflow', label: 'Sales Workflow', icon: 'HomeIcon', href: '/sales-workflow', group: 'main' },
  { id: 'nav-maintenance', label: 'Maintenance', icon: 'WrenchIcon', href: '/maintenance', badge: 3, group: 'main' },
  ...
  { id: 'nav-data-import', label: 'Data Import / Export', icon: 'ArrowUpDownIcon', href: '/data-import-export', group: 'compliance' },
  { id: 'nav-csv-upload', label: 'CSV Upload', icon: 'UploadCloudIcon', href: '/csv-upload', group: 'compliance' },
{ id: 'nav-property-field-import', label: 'Property Field Import', icon: 'DatabaseIcon', href: '/property-field-import', group: 'compliance' },
  { id: 'nav-csv-diff', label: 'CSV Row Diff', icon: 'GitCompareIcon', href: '/csv-diff', group: 'compliance' },
  { id: 'nav-import-batches', label: 'Import Batches', icon: 'LayersIcon', href: '/import-batches', group: 'compliance', minRole: 'manager' },
  { id: 'nav-import-history', label: 'Import History', icon: 'HistoryIcon', href: '/import-history', group: 'compliance', minRole: 'manager' },
  ...
  { id: 'nav-bulk-data-editor', label: 'Bulk Data Editor', icon: 'TableIcon', href: '/bulk-data-editor', group: 'compliance', minRole: 'manager' },
  { id: 'nav-building-codes', label: 'Building Code Mapper', icon: 'BuildingIcon', href: '/building-codes', group: 'compliance', minRole: 'manager' },
  { id: 'nav-data-validation', label: 'Data Validation', icon: 'ShieldCheckIcon', href: '/data-validation', group: 'compliance', minRole: 'manager' },
  { id: 'nav-import-quality', label: 'Import Quality', icon: 'ClipboardCheckIcon', href: '/import-quality', group: 'compliance', minRole: 'manager' },
  { id: 'nav-failed-rows', label: 'Failed Import Rows', icon: 'AlertCircleIcon', href: '/failed-rows', group: 'compliance', minRole: 'manager' },
  ...
  { id: 'nav-batch-export-fix', label: 'Batch Export & Fix', icon: 'FileOutputIcon', href: '/batch-export-fix', group: 'compliance', minRole: 'manager' },
  { id: 'nav-workflow-summary', label: 'Workflow Summary', icon: 'FileCheckIcon', href: '/workflow-summary', group: 'compliance', minRole: 'manager' },
  ...
  { id: 'nav-debug-env', label: 'Debug: Env & Supabase', icon: 'BugIcon', href: '/debug-env', group: 'admin', minRole: 'admin' },
  { id: 'nav-pipeline-test', label: 'Pipeline Test', icon: 'FlaskConicalIcon', href: '/pipeline-test', group: 'admin', minRole: 'admin' },
  { id: 'nav-activity-log', label: 'Activity Log', icon: 'ActivityIcon', href: '/activity-log', group: 'admin', minRole: 'manager' },
  { id: 'nav-settings', label: 'Settings', icon: 'SettingsIcon', href: '/dashboard', group: 'admin', minRole: 'manager' },
  { id: 'nav-agent-metrics', label: 'Agent Performance', icon: 'BarChart2Icon', href: '/agent-metrics', group: 'admin', minRole: 'manager' },
];
